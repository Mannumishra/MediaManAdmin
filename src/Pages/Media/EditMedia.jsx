...
const EditMedia = () => {
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            try {
                const res = await axios.get(`https://mediamanserver.onrender.com/api/media/${_id}`);
                console.log(res)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.put(`https://mediamanserver.onrender.com/api/media/${_id}`, formData);
            if(res.status===200){
